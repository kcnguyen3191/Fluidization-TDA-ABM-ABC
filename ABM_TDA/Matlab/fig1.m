...
%% tSNE
%(15,2), (9,5), (5,5), (15,7), (25,25)

Cs = [1.5, 1.8]%[2.0, 0.7, 1.8, 0.2, 1.5, 2.5];%[0.7, 0.9, 0.5, 0.5, 1.5, 2.0]; % 2.0, 1.5, 2.5 
Ls = [0.7, 0.4]%[0.1, 2.5, 0.4, 1.5, 0.7, 2.5];%[0.2, 0.5, 0.5, 1.5, 0.7, 2.0]; % 2.0, 2.5, 1.5

% (1.8, 0.4)

load('Simulated_Grid/ODE/tsne_mat_angles_SD_n2p2.mat');
