...
def obj_func(free_params,fixed_param_dict,ic_vec,time_vec,metric,true_metric,
             verbose=False):
...
#         #Return GMSE between metrics
        residuals = (true_metric-pred_metric)**2
...
def opt_par_search(true_df,estim_params,fixed_params,frame_vec,metric,
                   output=sys.stdout):
